...
that runs nothing and reports green is the failure this suite exists to prevent. CI runs the
same one command on every push, and a pre-push hook runs it before you can push.
